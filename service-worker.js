const CACHE='dataweave-lab-v1';
const CORE=['./','./index.html','./explorer.html','./assistant.html','./progress.html','./practice-bank.html','./lab-v2.html','./auth.js','./learning.js','./manifest.webmanifest'];
