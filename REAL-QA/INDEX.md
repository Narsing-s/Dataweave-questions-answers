...
- [A452-A456 — DataWeave Maven testing and delivery gaps](./FINAL-GAPS-452-456.md)
- [A457-A461 — Current tooling and Maven delivery gaps](./FINAL-GAPS-457-461.md)
- [A462-A464 — Current security and extension gaps](./FINAL-GAPS-462-464.md)
- [A465-A467 — Current annotation gaps](./FINAL-GAPS-465-467.md)
- [A468-A470 — Current annotation-target/metadata gaps](./FINAL-GAPS-468-470.md)
- [A471-A472 — Current metadata-operation gaps](./FINAL-GAPS-471-472.md)
- [A473 — Current visibility-migration gap](./FINAL-GAPS-473.md)
- [A474-A475 — Current DataWeave Extension dependency/testing gaps](./FINAL-GAPS-474-475.md)
- [A476 — Current DataWeave Extension workspace gap](./FINAL-GAPS-476.md)
- [A477-A478 — Current DataWeave Extension integration/debugging gaps](./FINAL-GAPS-477-478.md)
- [A479-A480 — Current DataWeave Extension authoring/scenario gaps](./FINAL-GAPS-479-480.md)
- [A481 — Current DataWeave Extension mapping-test gap](./FINAL-GAPS-481.md)
- [A482 — Current DataWeave component-type gap](./FINAL-GAPS-482.md)
- [A483 — Current DataWeave Extension project-bootstrap gap](./FINAL-GAPS-483.md)
- [A484-A486 — Current DataWeave Extension dependency/authoring/preview gaps](./FINAL-GAPS-484-486.md)
